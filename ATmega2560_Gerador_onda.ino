...
void timer(){
  ...
  OCR1A = 999;    // (16MhZ / (8*sampling freq)-1),  if samplinf freq = 125kHz = OCR1A = 15
  OCR1B = 999;   // sampling frequency // OCR1A  39 for 50kHz sampling freq. // = 99 for 20 kHz // = 199 for 10kHz // = 399 for 5kHz // 999 for 2kHz // 
